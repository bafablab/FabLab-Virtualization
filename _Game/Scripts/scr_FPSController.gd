...
onready var sensor_menu = get_node("/root/FabLab/UI_SensorMenu")
...
func _process(_delta):
	...
	if (main_menu.visible or item_info_menu.visible or device_info_menu.visible or generic_info_menu.visible or welcome_window.visible or sensor_menu.visible):
		moving = false
